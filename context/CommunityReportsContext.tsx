...
const mockReports: CommunityReport[] = [
  {
    ...
    description:
      "There is a massive pothole on the main road near Connaught Place causing severe traffic jams. Several vehicles have already damaged their tires and it's getting worse with the recent rains.",
    type: "pothole",
    imageUri: undefined,
    location: {
      latitude: 28.6139,
  ...
  },
  {
    ...
    description:
      "The streetlight at the corner near Bandra railway station has been out for over a week. This area is very dark at night and poses safety risks for commuters and pedestrians.",
  ...
  },
  {
    ...
    description:
      "The garbage bins near Koramangala tech park are overflowing and attracting stray dogs. Waste is scattered around making it unsightly and creating health concerns for office workers.",
    type: "garbage",
    imageUri: undefined,
    location: {
      latitude: 12.9279,
  ...
  },
  {
    ...
    description:
      "Weeds and wild grass have grown over the footpath in Salt Lake, making it difficult for pedestrians to walk safely. People are forced to walk on the busy road to avoid it.",
    type: "overgrown-weed",
    imageUri: undefined,
    location: {
      latitude: 22.5726,
  ...
  },
  {
    ...
    description:
      "A dangerous pothole has formed right near the school entrance in Malviya Nagar. Children and parents are having difficulty navigating around it safely.",
    type: "pothole",
    imageUri: undefined,
    location: {
      latitude: 26.8467,
  ...
  },
  {
    ...
    description:
      "Five consecutive streetlights are not working on the main road in Navrangpura. Local shopkeepers are concerned about security and customers avoid the area after dark.",
    type: "broken-streetlight",
    imageUri: undefined,
    location: {
      latitude: 23.0225,
  ...
  },
  {
    ...
    description:
      "Construction waste and household garbage has been illegally dumped in the residential area. It's attracting rats and creating unhygienic conditions for families.",
    type: "garbage",
    imageUri: undefined,
    location: {
      latitude: 17.385,
  ...
  },
  {
    ...
    description:
      "Wild thorny bushes have grown across the dedicated cycle track on Rajpur Road. Cyclists are getting injured and many have stopped using this route.",
    type: "overgrown-weed",
    imageUri: undefined,
    location: {
      latitude: 30.3165,
  ...
  },
  {
    ...
    description:
      "A huge pothole has formed on the service road that looks more like a crater. Small vehicles can get stuck and it needs emergency repairs immediately.",
    type: "pothole",
    imageUri: undefined,
    location: {
      latitude: 21.1458,
  ...
  },
  {
    ...
    description:
      "All streetlights in the community park in Sigra have stopped working. Women and children don't feel safe using the park in the evening anymore.",
    type: "broken-streetlight",
    imageUri: undefined,
    location: {
      latitude: 25.3176,
  ...
  },
  {
    ...
    description:
      "Hazardous medical waste has been improperly dumped behind the government hospital in Panaji. This poses serious health risks to the community.",
    type: "garbage",
    imageUri: undefined,
    location: {
      latitude: 15.2993,
  ...
  },
  {
    ...
    description:
      "Fast-growing invasive weeds are damaging apartment building walls in RS Puram. The roots are causing cracks and threatening structural integrity.",
    type: "overgrown-weed",
    imageUri: undefined,
    location: {
      latitude: 11.0168,
