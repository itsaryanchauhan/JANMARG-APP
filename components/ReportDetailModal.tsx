        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.timelineLeft}>
                      <View style={[
                        ...
                        <Ionicons 
                          ...
                          size={16} 
                          color={entry.timestamp ? "#fff" : (isCurrent ? "#e32f45" : "#ccc")} 
                        />
                      </View>
                      {!isLast && (
                        <View style={[
          ...
          <View style={styles.section}>
            ...
            >
              ...
              />
              <Text style={[styles.upvoteText, report.hasUserUpvoted && styles.upvoteTextActive]}>
                {report.upvotes} {report.upvotes === 1 ? 'person supports' : 'people support'} this report
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
